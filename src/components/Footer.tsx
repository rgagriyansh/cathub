        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-[var(--muted)] text-sm max-w-sm leading-relaxed">
              Your AI-powered companion for MBA applications. From SOPs to interview prep, we've got you covered.
            </p>
          </div>

          {/* Links */}
          <div>
            <h4 className="font-[family-name:var(--font-syne)] font-semibold mb-4">Product</h4>
            <ul className="space-y-3">
              <li>
                <Link href="/dashboard/mba-writer" className="text-sm text-[var(--muted)] hover:text-[var(--foreground)] transition-colors">
                  MBA Writer
                </Link>
              </li>
              <li>
                <span className="text-sm text-[var(--muted)]/50">
                  Interview Prep (Soon)
                </span>
              </li>
              <li>
          ...
          <div>
            <h4 className="font-[family-name:var(--font-syne)] font-semibold mb-4">Company</h4>
            <ul className="space-y-3">
              <li>
